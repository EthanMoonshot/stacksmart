...
const refreshes = {
  ...
  marketingAgency: {
    ...
    checklist: ["Export agency card and bank software charges", "Pull invoices for SEO, reporting, design, AI, social, CRM, and PM tools", "Group charges by agency job and client-project residue", "Assign owner, renewal date, payment account, and action"],
    faq: [
      ["What does a marketing agency software audit cover?", "It covers billing for SEO tools, reporting dashboards, social schedulers, design apps, AI subscriptions, project management, CRM, proposal, contractor, and client-campaign tools so the owner can find duplicate accounts, converted trials, unused seats, and ownerless renewals."],
      ["Does StackSmart need access to client campaign data?", "No. The first pass uses invoices, billing exports, and card statements only. Client ad accounts, analytics properties, creative files, and campaign data are not required."],
    ],
    links: [["Bookkeeping firm audit", "/bookkeeping-firm-software-stack-audit"], ["Professional services audit", "/professional-services-software-audit"], ["Business subscription tracker", "/business-subscription-tracker-small-business"]],
  },
  professionalServices: {
    eyebrow: "2026 owner-led professional services refresh",
    title: "A billing-first audit for boutique firms with too many delivery tools",
    answer:
    ...
    checklist: ["Export card, bank, and accounting recurring charges", "Collect proposal, CRM, PM, time, document, AI, and e-sign invoices", "Tag each subscription by delivery, sales, admin, or client-project job", "Return a keep, cancel, downgrade, consolidate, renegotiate, or owner action"],
    faq: [
      ["Who is a professional services software audit for?", "It is for owner-led consultancies and boutique service firms with roughly 5-50 staff that have accumulated proposal, CRM, time tracking, project management, e-signature, AI, reporting, and client-project subscriptions without a formal procurement process."],
      ["What files are needed for the first audit pass?", "Billing exports, invoices, card statements, and a rough list of current users are enough. StackSmart does not need client files, commercial advice documents, or project deliverables."],
    ],
    links: [["Marketing agency audit", "/marketing-agency-software-stack-audit"], ["Small business software audit", "/small-business-software-audit"], ["Small business software inventory", "/small-business-software-inventory"]],
  },
  childcare: {
    eyebrow: "2026 owner-led childcare stack refresh",
    title: "Audit centre subscriptions without touching child or family records",
    answer:
    ...
    checklist: ["Export card, bank, Xero, MYOB, or centre-management software charges", "Collect parent-comms, CCS, enrolment, rostering, payroll, payments, and learning-story invoices", "Compare seat counts with current educators/admin users", "Produce keep, cancel, downgrade, consolidate, renegotiate, and renewal-owner actions"],
    faq: [
      ["Can childcare centres audit software without child records?", "Yes. StackSmart starts with billing exports, invoices, card statements, and subscription ownership notes. Child records, family records, attendance data, learning stories, and CCS case details are not needed for the billing-layer review."],
      ["Where does subscription waste appear in childcare centres?", "Common waste appears in duplicate parent communication tools, enrolment/forms apps, rostering and payroll overlap, payment add-ons, learning-story apps, training portals, marketing tools, and subscriptions left active after director or administrator handover."],
    ],
    links: [["Community care audit", "/community-care-software-subscription-audit"], ["Clinic software audit", "/clinic-software-subscription-audit"], ["Software audit checklist", "/software-subscription-audit-checklist"]],
  },
  communityCare: {
    ...
    checklist: ["Export Xero/MYOB, card, bank, and direct-debit recurring software charges", "Collect care-management, roster, forms, SMS, payroll, compliance, document, and AI/admin invoices", "Compare coordinator, support-worker, and admin seat counts to current users", "Assign keep, cancel, downgrade, consolidate, renegotiate, and renewal-owner decisions"],
    faq: [
      ["What does a community care software audit cover?", "It covers the subscription and billing layer around care management, rostering, forms, documents, SMS, payroll, compliance, accounting, reporting, and AI/admin tools so owners can find waste without reviewing participant data."],
      ["What output does StackSmart produce for a care provider?", "The output is a short action list: keep, cancel, downgrade, consolidate, renegotiate, assign renewal owner, confirm payment account, and note last-confirmed-still-needed for each recurring software charge."],
    ],
    links: [["NDIS provider audit", "/ndis-provider-software-audit"], ["Childcare audit", "/childcare-software-subscription-audit"], ["SaaS spend audit tool", "/saas-spend-audit-tool"]],
  },
  xero: {
...
const dailyProductionNotes: Partial<Record<RefreshKey, {
  ...
  bookkeeping: {
    ...
    exportList: ["Firm card, bank, Xero, QBO, MYOB, and marketplace billing exports", "Receipt capture, payroll, workflow, proposal, e-sign, AI, reporting, and connector invoices", "Current user/seat list and payment-account notes", "Last-confirmed-still-needed notes for any subscription nobody clearly owns"],
    actionList: ["Separate firm-owned subscriptions from client pass-through costs", "Find cancelled-but-still-charged, duplicate, and ownerless tools", "Right-size idle seats and AI licences", "Assign keep, cancel, downgrade, consolidate, renegotiate, and renewal-owner decisions"],
    notFor:
  ...
  marketingAgency: {
    ...
    exportList: ["Agency card, bank, Xero, or MYOB recurring charges", "SEO, reporting, design, AI, social, CRM, PM, proposal, and contractor-tool invoices", "Current staff, contractor, and client-project owner notes", "Renewal dates, payment accounts, and last-confirmed-still-needed notes"],
    actionList: ["Find converted trials and client-campaign tools that became permanent charges", "Consolidate duplicate SEO/reporting/social/design/AI tools", "Remove departed contractor and idle seat costs", "Assign each recurring bill a renewal owner and payment account"],
    notFor:
  ...
  professionalServices: {
    ...
    exportList: ["Card, bank, and accounting recurring software charges", "Proposal, CRM, time tracking, PM, e-sign, document, AI, and reporting invoices", "Current user list and principal/admin owner notes", "Renewal dates, payment account, and last-confirmed-still-needed fields"],
    actionList: ["Find client-project tools that kept billing after delivery", "Compare duplicate proposal, CRM, PM, time, e-sign, AI, and document tools", "Right-size idle seats and annual renewals", "Create one renewal-owner register for the principal/admin handoff"],
    notFor:
  ...
  childcare: {
    ...
    exportList: ["Centre card, bank, Xero, MYOB, or direct-debit recurring charges", "Parent-comms, CCS/admin, enrolment, forms, rostering, payroll, payments, learning-story, compliance, training, marketing, and AI/admin invoices", "Current educator/admin seat counts", "Director/admin handover notes, renewal dates, and payment accounts"],
    actionList: ["Find duplicate parent-comms, forms, payments, rostering, payroll, and learning-story tools", "Remove idle educator/admin seats", "Flag cancelled-but-still-charged subscriptions after director handover", "Assign keep, cancel, downgrade, consolidate, renegotiate, and renewal-owner actions"],
    notFor:
  ...
  communityCare: {
    ...
    exportList: ["Provider card, bank, Xero, MYOB, and direct-debit recurring charges", "Care-management, rostering, plan-management, forms, document, SMS, payroll, compliance, accounting, reporting, and AI/admin invoices", "Current coordinator, support-worker, and admin seat counts", "Renewal dates, billing contacts, payment accounts, and last-confirmed-still-needed notes"],
    actionList: ["Find duplicate roster, care, forms, document, SMS, payroll, compliance, and AI/admin tools", "Remove ghost worker/coordinator/admin seats", "Flag ownerless renewals from admin handoff gaps", "Create keep, cancel, downgrade, consolidate, renegotiate, and renewal-owner decisions"],
    notFor:
        ...
        <div className="rounded-3xl border border-cyan-400/20 bg-cyan-400/[0.06] p-6 shadow-2xl shadow-cyan-950/20 sm:p-8">
          ...
          {dailyNote ? (
            <div className="mt-6 rounded-2xl border border-emerald-300/20 bg-emerald-300/[0.06] p-5">
              <p className="text-xs font-semibold uppercase tracking-[0.22em] text-emerald-200">2026-07-02 owner-led SMB refresh</p>
