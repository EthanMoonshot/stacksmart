          ...
          <div className="max-w-xl animate-fade-up">
            ...
            <div className="inline-flex items-center gap-2 rounded-full border border-success-500/25 bg-success-500/10 px-4 py-2 mb-8">
              ...
              <span className="font-sans text-xs font-semibold text-success-400 tracking-wide">
                Public sample report live now
              </span>
            </div>

            <h1 className="font-clash text-5xl font-semibold leading-[1.04] tracking-[-0.02em] text-white sm:text-6xl lg:text-[68px]">
              Cut wasted SaaS spend without doing a full finance audit.
            </h1>

            <p className="mt-6 font-sans text-lg leading-relaxed text-dark-300 max-w-lg">
              Start with the public sample report, then upload a billing CSV when you are ready to find duplicate tools, overpriced subscriptions, and clear savings actions.
            </p>

            <div className="mt-10 flex flex-col sm:flex-row gap-4">
              <a
                href="/demo"
                aria-label="Run the free StackSmart demo"
                onClick={() => trackEvent("homepage_cta_clicked", { target: "demo", location: "hero_primary" })}
              ...
              <a
                href="/pricing"
                aria-label="See StackSmart pricing and buying options"
                onClick={() => trackEvent("homepage_cta_clicked", { target: "pricing", location: "hero_secondary" })}
            ...
            <p className="mt-5 font-sans text-sm text-dark-400">
              No credit card · No sign-up · See the real report before you buy
            </p>
          </div>
