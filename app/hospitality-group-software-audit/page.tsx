...
export const metadata: Metadata = buildMetadata({
  title:
    "Hospitality Group Software Audit | Cut Subscription Waste Across Your Venues",
  description:
  ...
  return (
    <main className="min-h-screen bg-dark-950 text-white">
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-lg leading-8 text-dark-300">
              Small hospitality groups and multi-site venues carry one of the
              most complex software stacks in the SMB market — POS,
              reservations, rostering, payroll, delivery integrations, loyalty,
              accounting, and marketing tools, often billed separately per site.
              High casual staff turnover and layered per-venue pricing make this
              stack expensive to maintain and easy to overpay. A software audit
              finds the duplication, idle seats, and renewals worth
              renegotiating.
            </p>
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <TrackLink
                ...
                props={{
                  target: "demo",
                  location: "hospitality_audit_primary",
                }}
              ...
              <TrackLink
                ...
                props={{
                  target: "pricing",
                  location: "hospitality_audit_secondary",
                }}
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl border border-brand-400/20 bg-dark-900/80 p-6 sm:p-8">
            ...
            <p className="mt-4 max-w-3xl text-sm leading-7 text-dark-300">
              ...
              business credit card — capturing charges across all venues, which
              are often billed to different payment methods. Group every
              recurring charge by category: POS, reservations, rostering,
              payroll, delivery integrations, loyalty, accounting, and
              marketing. Flag categories where you are paying per-site for tools
              that offer group pricing. Cross-reference staff accounts in
              rostering and payroll tools against your current active headcount
              and remove idle accounts from the last seasonal cycle. Check
              annual contract renewal dates on your POS, reservations, and
              rostering platforms — these are your highest-value renegotiation
              targets. Assign each subscription a decision and act on seat
              removals and cancellations first.
            </p>
            <p className="mt-4 max-w-3xl text-sm leading-7 text-dark-300">
              2026 proof refresh: today’s DataForSEO AU live check showed
              restaurant management software at 70 monthly searches / $20.98 CPC
              / $19.33 high bid, hospitality software at 40 / $28.88 CPC /
              $37.56 high bid, POS software Australia at 210 / $30.24 CPC /
              $28.15 high bid, and POS system for small business at 210 / $50.98
              CPC / $53.03 high bid. StackSmart is not trying to replace the
              operating platform. It audits the subscription layer around that
              platform for an owner-led 5-50 staff multi-site venue group,
              restaurant group, cafe group, or bar operator: POS and
              reservations add-ons, delivery/order integrations, rostering and
              payroll connectors, loyalty and review tools, Wi-Fi/guest
              analytics, SMS/email packs, music, signage, and per-site contracts
              renewed without group pricing review. Start with Xero or MYOB
              exports, business-card statements, venue-level direct debits,
              POS/reservation invoices, delivery-integration invoices, and
              marketing/review platform receipts. The output is a practical
              keep, cancel, downgrade, consolidate, renegotiate, and
              renewal-owner action list before notice windows or auto-renewals
              close.
            </p>
          </div>
        </div>
      ...
      <section className="py-14 sm:py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-dark-300">
            Most small multi-site hospitality groups are running 10 to 18
            recurring subscriptions across these categories — some billed at a
            group level, others per venue.
          </p>
      ...
      <section className="border-b border-dark-800/80 py-14 sm:py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-semibold text-white">
            Venue-level add-ons and costs hidden outside the main software
            review
          </h2>
          <p className="mt-3 max-w-2xl text-sm leading-7 text-dark-300">
            The highest-value missed costs in hospitality group billing exports
            appear outside the headline platform categories.
          </p>
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            {[
              [
      ...
      <section className="border-y border-dark-800/80 py-14 sm:py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-dark-300">
            These are the patterns StackSmart most commonly surfaces when
            reviewing hospitality group billing exports.
          </p>
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            {wasteSignals.map((s) => (
              <div
      ...
      <section className="py-14 sm:py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-dark-300">
            Designed to run in the quieter trading periods. No dedicated ops or
            finance function required.
          </p>
      ...
      <section className="border-y border-dark-800/80 py-14 sm:py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-dark-300">
            ...
            hospitality group billing data. Actual amounts vary by venue count,
            headcount, and stack.
          </p>
          <div className="mt-8 overflow-x-auto">
            <table className="w-full text-left text-sm">
              ...
              <tbody className="text-dark-300">
                {[
                  [
                    "3 venues on individual reservation platform rates",
                    "Negotiate group licence",
                    "$1,800 – $6,000/yr",
                  ],
                  [
                    "12 idle casual staff accounts in rostering tool",
                    "Remove inactive accounts",
                    "$720 – $3,600/yr",
                  ],
                  [
                    "Two delivery integration tools across overlapping platforms",
                    "Consolidate to one",
                    "$960 – $3,200/yr",
                  ],
                  [
                    "Loyalty platform active with no running programme",
                    "Cancel or pause",
                    "$480 – $1,800/yr",
                  ],
                  [
                    "Email marketing on Agencies tier, two-venue newsletter usage",
                    "Downgrade to standard plan",
                    "$600 – $2,400/yr",
                  ],
                  [
                    "Annual rostering contract at peak seasonal headcount",
                    "Renegotiate to current active count",
                    "$1,200 – $4,800/yr",
                  ],
      ...
      <section className="py-14 sm:py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-dark-300">
            ...
            step so the review happens during a quiet trading week rather than
            never.
          </p>
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            <div className="rounded-2xl border border-dark-700 bg-dark-900/70 p-6">
              ...
              <ul className="mt-4 space-y-3 text-sm leading-7 text-dark-200">
                ...
                <li>
                  Owner, operator, or general manager responsible for software
                  decisions
                </li>
                <li>
                  Paying for POS, rostering, reservations, and at least 3 other
                  tools
                </li>
            ...
            <div className="rounded-2xl border border-dark-700 bg-dark-900/70 p-6">
              ...
              <ul className="mt-4 space-y-3 text-sm leading-7 text-dark-400">
                <li>
                  Large hospitality group with a corporate ops or finance
                  function
                </li>
                <li>
      ...
      <section className="border-y border-dark-800/80 bg-dark-900/30 py-16 sm:py-20">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="mt-3 text-2xl font-semibold tracking-tight text-white">
            Run the venue software audit from card statements and accounting
            exports
          </h2>
          <p className="mt-4 text-sm leading-7 text-dark-300">
            Hospitality operators do not need a procurement system to review
            software costs. The practical starting point is the same as any
            owner-led SMB: pull billing data, match each charge to a current
            venue and workflow, and make a keep/cancel/consolidate/renegotiate
            decision before auto-renewals process. The difference is that
            hospitality stacks multiply across sites — every venue adds its own
            POS add-ons, rostering seats, delivery integrations, music
            licensing, and review tools.
          </p>
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-2">
            <div className="rounded-2xl border border-brand-400/20 bg-dark-900/80 p-6">
              ...
              <p className="mt-3 text-sm leading-7 text-dark-300">
                Every site multiplies the stack: POS at each venue, reservations
                per location, rostering seats for each team, delivery
                integrations per kitchen, music licensing per trading floor, and
                review/reputation tools per listing. A three-venue operator
                often pays three times what a single-site equivalent would —
                without ever negotiating group rates or consolidating accounts.
                The billing export reveals the full per-site multiplication in
                one pass.
              </p>
            </div>
            <div className="rounded-2xl border border-brand-400/20 bg-dark-900/80 p-6">
              ...
              <p className="mt-3 text-sm leading-7 text-dark-300">
                The useful output is a venue-by-venue action board: keep
                production-critical POS and rostering, cancel dormant
                delivery/loyalty/marketing tools, right-size rostering seats to
                current headcount, consolidate per-site reservations and review
                tools to group pricing, renegotiate annual POS and rostering
                contracts using multi-site leverage, and assign renewal
                ownership to the operator, GM, or venue manager responsible for
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <TrackLink
              href="/demo"
              event="homepage_cta_clicked"
              props={{ from: "hospitality_2026_06_08", target: "demo" }}
              className="btn-primary text-sm"
            >
              See sample venue report
            </TrackLink>
            <TrackLink
              href="/saas-spend-audit-tool"
              event="homepage_cta_clicked"
              props={{ from: "hospitality_2026_06_08", target: "audit_tool" }}
      ...
      <OwnerLedRefreshSection type="hospitality" />
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
            ...
            <TrackLink
              ...
              props={{
                target: "pricing",
                location: "hospitality_audit_footer",
              }}
              className="btn-secondary text-sm sm:text-base"
            >
              Compare plans
