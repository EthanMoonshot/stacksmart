    ...
    <main className="min-h-screen bg-dark-950 text-white">
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <p className="text-xs uppercase tracking-[0.18em] text-brand-300">
              Bookkeeping firm software audit · 2026-06-26 refresh
            </p>
            <h1 className="mt-4 text-4xl font-bold tracking-tight sm:text-5xl">
              Audit the add-on sprawl in your bookkeeping firm stack
            </h1>
            <p className="mt-6 text-lg leading-8 text-dark-300">
              Bookkeeping firms running on Xero, QBO, or MYOB accumulate
              ecosystem add-ons faster than almost any other professional
              services business. Receipt capture tools, payroll platforms,
              e-sign subscriptions, proposal tools, AI transcription apps,
              client portals, workflow apps, and connector fees — many with
              significant feature overlap that nobody has reviewed since the
              initial signup. Recurring payments that looked justified at launch
              quietly compound into thousands per year in waste. StackSmart
              gives you a practical software-spend snapshot — not an enterprise
              procurement platform — so the firm owner or principal can see what
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <TrackLink
                ...
                props={{
                  target: "demo",
                  location: "bookkeeping_audit_primary",
                }}
              ...
              <TrackLink
                ...
                props={{
                  target: "pricing",
                  location: "bookkeeping_audit_secondary",
                }}
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl border border-brand-400/20 bg-dark-900/80 p-6 sm:p-8">
            ...
            <p className="mt-4 max-w-3xl text-sm leading-7 text-dark-300">
              Export 6 to 12 months of billing data from Xero, QBO, MYOB, or
              your business credit card — and also pull your Xero or QBO
              marketplace billing separately, which is where connector fees and
              add-on charges often hide. Clearly separate subscriptions used for
              internal firm operations from any client-pass-through billing,
              then group firm subscriptions by category: bookkeeping platform,
              receipt and expense capture, payroll, proposals and engagement
              letters, e-sign, client portal and document management, workflow
              and practice management, AI tools, connector and integration fees,
              and marketing. For any category with more than one active tool,
              check what your primary bookkeeping or practice management
              platform now includes natively. Cross-reference user lists against
              current staff headcount for every per-seat subscription —
              including AI tools where seat counts are often set at onboarding
              and never reviewed. Flag annual contracts renewing within 90 days
              as renegotiation targets. Map every active connector fee to the
              two tools it joins — connectors for tools already consolidated are
      ...
      <section className="border-b border-dark-800/80 bg-dark-900/30 py-14 sm:py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl border border-brand-400/15 bg-dark-900/80 p-6 sm:p-8">
            ...
            <h2 className="mt-3 text-xl font-semibold text-white sm:text-2xl">
              What a bookkeeping firm principal can find in 30 minutes from the
              card statement
            </h2>
            <p className="mt-4 text-sm leading-7 text-dark-300">
              You do not need a full audit to spot the most common waste. Pull
              the last three months of the firm credit card and any marketplace
              billing accounts (Xero, QBO, MYOB). Software bills spread across a
              business card, a personal card, and ecosystem marketplace accounts
              are easy to miss when reviewed separately — this is the
              finance-truth step that tells you what the practice is actually
              paying for. In 30 minutes, work through the categories that most
              often carry recoverable spend:
            </p>
            <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                <div
                  key={step}
                  className="rounded-xl border border-dark-700 bg-dark-800/60 p-5"
                >
            ...
            <p className="mt-6 text-sm leading-7 text-dark-300">
              If you find more than two flags in 30 minutes, a full billing
              export audit will almost always surface additional savings.
              StackSmart automates the full categorisation so you move straight
              from billing export to action list.
            </p>
            <div className="mt-6 flex gap-3">
              <TrackLink
                ...
                props={{
                  target: "audit_tool",
                  location: "bookkeeping_quick_start",
                }}
      ...
      <section className="py-14 sm:py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-dark-300">
            Three patterns drive the majority of software waste in Xero- and
            QBO-based bookkeeping practices.
          </p>
      ...
      <section className="border-b border-dark-800/80 bg-dark-900/30 py-14 sm:py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="mt-2 text-2xl font-semibold text-white">
            Why bookkeeping firm software bills are spread across multiple
            accounts
          </h2>
          <p className="mt-3 max-w-2xl text-sm leading-7 text-dark-300">
            One of the most common reasons bookkeeping firm principals do not
            have a clear picture of their software spend is that the charges are
            never in one place. A software audit starts by consolidating all
            payment paths before going line by line.
          </p>
          <div className="mt-8 space-y-4">
            {[
              ...
              <div
                key={item.source}
                className="flex gap-4 rounded-2xl border border-dark-700 bg-dark-900/70 p-5"
              >
                <div className="flex-1">
                  <p className={`text-sm font-semibold ${item.color}`}>
                    {item.source}
                  </p>
                  <p className="mt-1.5 text-sm leading-7 text-dark-400">
                    {item.detail}
                  </p>
                </div>
              </div>
          ...
          <div className="mt-6 rounded-2xl border border-dark-700 bg-dark-900/50 p-5">
            <p className="text-sm leading-7 text-dark-300 max-w-3xl">
              A complete bookkeeping firm software audit covers all four payment
              paths. The easiest starting point is 12 months of the firm credit
              card plus a download of the Xero or QBO marketplace billing
              history. Together, these two sources capture the majority of
              recurring spend. StackSmart processes any billing export CSV —
              export everything into one file and upload it as a single audit
              run. See the{" "}
              <a
                href="/software-subscription-audit-checklist"
              ...
              for the full structured workflow before uploading.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="border-y border-dark-800/80 py-14 sm:py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-dark-300">
            Most small bookkeeping firms running 1 to 20 staff are paying for 10
            to 16 recurring subscriptions across these categories — plus
            additional connector and integration fees that do not appear in the
      ...
      <section className="border-b border-dark-800/80 bg-dark-900/30 py-14 sm:py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-dark-300">
            Beyond the named tool subscriptions, bookkeeping firms accumulate a
            separate layer of connector and integration fees. These are
            recurring charges billed for automation workflows, API syncs, and
            marketplace add-ons that keep tools talking to each other. They are
            easy to miss in a card-statement review because they appear as
            small-dollar line items, not named software products.
          </p>
          ...
          <div className="mt-6 rounded-2xl border border-dark-700 bg-dark-900/50 p-5">
            ...
            <p className="mt-2 text-sm leading-7 text-dark-300 max-w-3xl">
              After building the main software inventory, list every connector
              and integration fee separately. For each connector, name the two
              tools it joins. If either tool has been consolidated, cancelled,
              or replaced with a native feature, mark the connector for
              immediate cut. Connectors for tools that are still active should
              be reviewed to confirm the automation is still running and that a
              native integration has not made it redundant. A two-hour connector
              cleanup pass in a Xero or QBO ecosystem typically saves $600 to
              $2,400 per year in fees that would otherwise roll over unreviewed.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-14 sm:py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-dark-300">
            These are the eight patterns StackSmart most commonly surfaces when
            reviewing bookkeeping firm billing exports.
          </p>
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
      ...
      <section className="border-y border-dark-800/80 py-14 sm:py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-dark-300">
            Designed to run outside peak client delivery periods. No dedicated
            ops function required.
          </p>
      ...
      <section className="py-14 sm:py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-dark-300">
            These are illustrative findings based on common patterns in
            bookkeeping firm billing exports. Actual amounts vary by firm size
            and stack.
          </p>
          <div className="mt-8 overflow-x-auto">
            <table className="w-full text-left text-sm">
              ...
              <tbody className="text-dark-300">
                {[
                  [
                    "Dext and Hubdoc both active on same firm account",
                    "Consolidate to one",
                    "$480 – $2,400/yr",
                  ],
                  [
                    "DocuSign running alongside practice management e-sign",
                    "Cancel DocuSign",
                    "$600 – $2,400/yr",
                  ],
                  [
                    "Otter.ai Business plan at 8 seats, 1 active user",
                    "Right-size to 1–2 seats",
                    "$1,200 – $1,680/yr",
                  ],
                  [
                    "ChatGPT Teams at 10 seats, 2 people actively using it",
                    "Right-size before annual renewal",
                    "$1,920 – $2,880/yr",
                  ],
                  [
                    "Ignition plus practice management proposals both active",
                    "Consolidate to one",
                    "$480 – $1,800/yr",
                  ],
                  [
                    "Payroll tool at 15-employee tier, 9 current staff",
                    "Renegotiate or downgrade",
                    "$720 – $3,600/yr",
                  ],
                  [
                    "Zapier connector fee for receipt capture tool that was cancelled",
                    "Cut connector",
                    "$240 – $960/yr",
                  ],
                  [
                    "QBO marketplace sync fee for reporting dashboard with native reports available",
                    "Cut add-on connector",
                    "$360 – $1,200/yr",
                  ],
                  [
                    "Workflow tool on annual contract above current seat count",
                    "Renegotiate to current headcount",
                    "$1,080 – $4,320/yr",
                  ],
      ...
      <section className="border-y border-dark-800/80 py-14 sm:py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-dark-300">
            StackSmart produces a practical software-spend snapshot for
            owner-led bookkeeping firms — not an enterprise procurement
            platform. The firm principal gets a clear view of recurring payments
            and a prioritised action list they can act on or hand off to a
            practice manager.
          </p>
          ...
          <div className="mt-6 rounded-2xl border border-dark-700 bg-dark-900/50 p-6">
            ...
            <p className="mt-3 text-sm leading-7 text-dark-300">
              The firm principal or bookkeeping practice owner typically runs
              the initial review and owns the cancellation and renegotiation
              decisions — including AI subscription seat right-sizing and
              connector fee cuts. The completed savings report is shared with a
              practice manager or office manager to handle seat removals and
              vendor conversations. It can be handed to a finance admin as a
              structured view of recurring payments — a line-by-line spend
              snapshot before they go through statements manually. Bookkeepers
              who work with SMB clients can also share the StackSmart concept as
              a practical advisory step for clients with unreviewed software
              spend.
            </p>
          </div>
        </div>
      ...
      <section className="py-14 sm:py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-dark-300">
            Both approaches surface the same waste. StackSmart removes the
            spreadsheet step so the review gets completed rather than deferred
            to the next quarter.
          </p>
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            <div className="rounded-2xl border border-dark-700 bg-dark-900/70 p-6">
              ...
              <ul className="mt-4 space-y-3 text-sm leading-7 text-dark-300">
                ...
                <li>
                  Manually separate firm billing from client-pass-through
                  billing
                </li>
                <li>
                  Categorise each add-on by function and check current feature
                  sets
                </li>
                <li>
            ...
            <div className="rounded-2xl border border-brand-400/30 bg-dark-900/70 p-6">
              ...
              <ul className="mt-4 space-y-3 text-sm leading-7 text-dark-300">
                ...
                <li>
                  Automatic categorisation across bookkeeping firm tool
                  categories
                </li>
                <li>
                  Flags receipt capture overlap, connector fees, idle seats, AI
                  seat waste, and renewal risks
                </li>
                <li>
                  Prioritised keep, cut, consolidate, cut connectors, and
                  renegotiate action list
                </li>
                <li>
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            <div className="rounded-2xl border border-dark-700 bg-dark-900/70 p-6">
              ...
              <ul className="mt-4 space-y-3 text-sm leading-7 text-dark-200">
                ...
                <li>
                  1 to 20 staff, principal or practice manager responsible for
                  software decisions
                </li>
                <li>
                  Multiple ecosystem add-ons across receipt, payroll, proposal,
                  AI tools, and document categories
                </li>
                <li>No dedicated IT or ops function managing subscriptions</li>
                <li>
                  Billing data accessible from Xero, QBO, or business credit
                  card statements
                </li>
              </ul>
            </div>
            <div className="rounded-2xl border border-dark-700 bg-dark-900/70 p-6">
              ...
              <ul className="mt-4 space-y-3 text-sm leading-7 text-dark-400">
                <li>
                  Large accounting or bookkeeping group with a dedicated IT or
                  operations function
                </li>
                <li>
                  Primary need is compliance audit tooling or AML/regulatory
                  review
                </li>
      ...
      <section className="border-y border-dark-800/80 bg-dark-900/40 py-14 sm:py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-sm leading-7 text-dark-300">
            The highest-value bookkeeping firm audit is not a generic software
            list. It is a practical owner review of which app is doing which
            job, who owns the renewal, and whether the firm can keep, cancel,
            downgrade, or consolidate before another annual charge lands.
          </p>
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            {[
              ...
              <div
                key={title}
                className="rounded-2xl border border-dark-700 bg-dark-950/70 p-5"
              >
                <h3 className="text-sm font-semibold text-white">{title}</h3>
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl border border-brand-400/20 bg-dark-900/70 p-6 sm:p-8">
            ...
            <h2 className="mt-3 text-2xl font-semibold tracking-tight text-white sm:text-3xl">
              When seven QuickBooks or Xero apps are all touching the same
              workflow
            </h2>
            <p className="mt-4 max-w-3xl text-sm leading-7 text-dark-300">
              The strongest bookkeeping waste signal is not just "too many
              apps"; it is duplicated admin work and connector sprawl. A small
              practice can have a receipt tool, payroll add-on, reporting
              dashboard, proposal app, e-sign tool, workflow system, and AI
              meeting assistant all connected to QuickBooks or Xero — plus a
              separate connector fee for each integration — then spend month end
              untangling duplicate transactions, wrong mappings, buried fees,
              and subscriptions nobody remembers approving. StackSmart turns the
              billing export into a software inventory, connector map, and
              renewal calendar so the principal can ask one concrete question
              per category: which app can we cancel or consolidate without
              breaking client delivery?
            </p>
            <div className="mt-6 grid gap-4 md:grid-cols-3">
              {[
                ...
                <div
                  key={step}
                  className="rounded-xl border border-dark-700 bg-dark-950/80 p-4"
                >
      ...
      <section className="border-y border-dark-800/80 py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <p className="text-xs uppercase tracking-[0.18em] text-brand-300">
            2026-06-11 proof refresh · measured AU demand
          </p>
          <div className="mt-4 grid gap-8 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              <h2 className="text-2xl font-semibold text-white">
                Bookkeeping firms need a billing-layer audit, not another
                practice platform.
              </h2>
              <p className="mt-4 text-sm leading-7 text-dark-300">
                June 2026 AU keyword data shows &ldquo;bookkeeping software
                Australia&rdquo; at 880 monthly searches (CPC $36.09, high bid
                $51.55) — strong commercial demand where the conversion wedge is
                not platform selection but subscription ownership. For an
                owner-led bookkeeping firm with 5 to 50 staff, the practical
                opportunity is finding the firm-owned add-ons,
                client-pass-through subscriptions, connector fees, AI seats,
                duplicate charges, and renewal owners that nobody has reviewed
                since the last growth phase or seasonal staffing cycle.
              </p>
              <p className="mt-4 text-sm leading-7 text-dark-300">
                StackSmart starts from firm billing exports, card statements,
                marketplace invoices, and subscription receipts only. It does
                not review client ledgers or client financial records. The
                output is a principal-friendly action list: keep, cancel,
                downgrade, consolidate, renegotiate, or assign a renewal owner
                before the next monthly or annual charge hits.
              </p>
            </div>
            <div className="rounded-3xl border border-dark-700 bg-dark-900/70 p-6">
              <h3 className="text-lg font-semibold text-white">
                Bookkeeping action map
              </h3>
              <div className="mt-5 grid gap-3">
                {[
                  ...
                  <div
                    key={item}
                    className="rounded-xl border border-dark-700/80 bg-dark-950/60 px-4 py-3 text-sm leading-6 text-dark-300"
                  >
                    {item}
                  </div>
                ))}
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <TrackLink
              ...
              event="homepage_cta_clicked"
              props={{
                from: "bookkeeping_firm_refresh",
                target: "xero_app_stack_audit",
              }}
              className="btn-secondary text-sm"
            >
              Audit Xero app billing
            </TrackLink>
            <TrackLink
              href="/software-subscription-audit-checklist"
              event="homepage_cta_clicked"
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl border border-brand-400/20 bg-dark-900/80 p-6 sm:p-8">
            ...
            <h2 className="mt-3 text-2xl font-semibold tracking-tight text-white">
              Bookkeeping software Australia holds at 880 monthly searches — the
              conversion gap is add-on ownership, not platform choice
            </h2>
            <p className="mt-4 text-sm leading-7 text-dark-300">
              Today&apos;s DataForSEO AU live check confirms &ldquo;bookkeeping
              software Australia&rdquo; at 880 monthly searches with a
              competition index of 46 and a high-bid CPC of $51.55 — the
              strongest measured commercial term in the accounting/bookkeeping
              cluster. For owner-led bookkeeping firms with 5 to 50 staff, the
              practical question is not which bookkeeping platform to switch to.
              It is which Xero, QBO, or MYOB add-ons are still earning their
              place this month — and who owns the renewal decision for each one.
            </p>
            <p className="mt-4 text-sm leading-7 text-dark-300">
              The billing-export pass starts from firm card statements,
              marketplace invoices, and direct debits. It separates firm-owned
              subscriptions from client-pass-through billing, then flags the
              patterns that compound across every quarter without a structured
              review: duplicate receipt capture tools where Dext and Hubdoc both
              run alongside a native platform feature, connector fees for
              integrations that were replaced by native sync, AI workspace seats
              purchased during the 2023&ndash;2024 adoption wave and never
              right-sized, converted trials on proposal and workflow tools,
              ghost users from seasonal contractors and departed bookkeepers,
              and ownerless annual renewals on practice management and reporting
              platforms.
            </p>
            <div className="mt-6 grid gap-4 md:grid-cols-3">
              {[
                [
                  "Firm vs client billing split",
                  "Separate firm-owned subscriptions from client-pass-through billing before cancellation decisions. The most common error is a client-engagement tool that migrated to firm cost after the client left — nobody noticed because it was never tagged.",
                ],
                [
                  "Duplicate-charge and connector cleanup",
                  "Flag receipt capture, workflow, reporting, proposal, e-sign, and AI tools overlapping with the core platform. Map every connector fee to the two tools it joins — connectors for consolidated tools are immediate cuts.",
                ],
                [
                  "Renewal-owner and notice-window pass",
                  "Build a 30/60/90-day renewal list with a named owner for each contract. Ownerless renewals auto-process at the previous tier and headcount — the window to renegotiate or cancel closes before anyone reviews the charge.",
                ],
              ].map(([title, detail]) => (
                <div
                  key={title}
                  className="rounded-xl border border-dark-700/80 bg-dark-950/70 p-4"
                >
                  <h3 className="text-sm font-semibold text-white">{title}</h3>
                  <p className="mt-2 text-xs leading-6 text-dark-300">
                    {detail}
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row">
              <TrackLink
                href="/software-subscription-audit-checklist"
                event="homepage_cta_clicked"
                props={{ from: "bookkeeping_2026_06_11", target: "checklist" }}
                className="btn-secondary text-sm"
              >
                Use the checklist
              </TrackLink>
              <TrackLink
                ...
                event="homepage_cta_clicked"
                props={{
                  from: "bookkeeping_2026_06_11",
                  target: "renewal_management",
                }}
                className="btn-primary text-sm"
              >
                Track renewal risk
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <p className="text-xs font-semibold uppercase tracking-[0.24em] text-brand-300">
              2026-06-26 practice-owner refresh
            </p>
            <h2 className="mt-3 text-2xl font-semibold text-white">
              Bookkeeping software bills hide across Xero apps, QBO add-ons,
              cards, and client-tool overlap
            </h2>
            <p className="mt-4 text-sm leading-7 text-dark-300">
              Today&apos;s DataForSEO AU check showed “bookkeeping software
              Australia” at 880 searches with $33.75 CPC, “accounting practice
              software” at 390 searches, and “Xero apps” at 260 searches. That
              demand is broader than software selection. For a 5-to-50-person
              bookkeeping firm, the commercial pain is usually the connected-app
              stack: Xero or QBO add-ons, receipt capture, payroll, practice
              management, proposals, e-sign, client portals, reporting, AI
              meeting notes, and connector fees all billing in different places.
            </p>
            <p className="mt-4 text-sm leading-7 text-dark-300">
              StackSmart treats the bookkeeping stack as a billing and ownership
              problem first. Pull the firm card, accounting export, marketplace
              billing, and invoices. Then assign each tool a job, owner, payment
              source, renewal date, last-confirmed-still-needed date, and action
              decision before the next busy-season or annual-plan renewal.
            </p>
          </div>
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            {[
              [
                "Xero and QBO connected apps",
                "Receipt capture, payroll, reporting, workflow, and client-portal add-ons often survive after the core platform or practice-management tool adds overlapping features.",
              ],
              [
                "Seasonal and former-staff seats",
                "Bookkeepers, contractors, and admin support can remain active after peak lodgement work, maternity cover, or short-term client projects end.",
              ],
              [
                "Connector and AI fees",
                "Zapier, Make, API sync tools, ChatGPT, transcription, and document automation subscriptions are easy to approve but rarely reviewed for active use.",
              ],
            ].map(([title, body]) => (
              <div
                key={title}
                className="rounded-3xl border border-dark-800 bg-dark-950/70 p-5"
              >
                <h3 className="text-sm font-semibold text-white">{title}</h3>
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <TrackLink
              ...
              event="homepage_cta_clicked"
              props={{
                from: "bookkeeping_2026_06_26",
                target: "software_inventory",
              }}
              className="btn-primary text-sm"
            >
      ...
      <section className="scroll-mt-24 border-b border-dark-800/80 bg-dark-900/40 py-14 sm:py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-6 lg:grid-cols-[1fr_1fr] lg:items-start">
            <div>
              <p className="text-xs font-medium uppercase tracking-[0.18em] text-brand-300">
                2026-07-09 refresh · bookkeeping firms
              </p>
              <h2 className="mt-3 text-2xl font-semibold text-white">
                Separate the firm’s paid stack from client work before the next
                QBO or Xero renewal
              </h2>
              <p className="mt-4 text-sm leading-7 text-dark-300">
                The current buyer pain is not only “which accounting app should
                we use?” It is “which add-ons are we still paying for, who owns
                them, and which are practice costs versus client-pass-through
                costs?” StackSmart reviews firm billing exports, card
                statements, app invoices, partner-tool receipts, and recurring
                expense categories to identify duplicate receipt-capture tools,
                old workflow trials, unused AI seats, shared-login risk,
                connector fees, and cancelled-but-still-charged vendors. It does
                not need client ledger access or sensitive client files.
              </p>
              <div className="mt-6 flex flex-wrap gap-3 text-sm">
                ...
                <TrackLink
                  href="/demo"
                  event="homepage_cta_clicked"
                  props={{ from: "bookkeeping_2026_07_09", to: "demo" }}
                  className="rounded-full border border-dark-700 px-4 py-2 text-brand-200 hover:border-brand-400/60"
                >
                  Sample report
                </TrackLink>
            ...
            <div className="rounded-2xl border border-dark-700 bg-dark-900/70 p-6">
              ...
              <ol className="mt-4 space-y-3 text-sm leading-7 text-dark-300">
                <li>
                  <span className="font-semibold text-white">1.</span> Which
                  QuickBooks, Xero, receipt, payroll, workflow, reporting, and
                  AI tools are firm-owned versus client-owned?
                </li>
                <li>
                  <span className="font-semibold text-white">2.</span> Which
                  recurring bills are duplicated across cards, owner accounts,
                  partner portals, and old shared logins?
                </li>
                <li>
                  <span className="font-semibold text-white">3.</span> Which
                  seats, connectors, and app tiers can be downgraded before the
                  next renewal or price increase?
                </li>
                <li>
                  <span className="font-semibold text-white">4.</span> Who owns
                  each renewal so the firm does not go line-by-line from scratch
                  every quarter?
                </li>
              </ol>
            </div>
      ...
      <section className="border-t border-dark-800/80 py-16">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-dark-300">
            ...
            a billing export, then decide if it fits your firm&apos;s review
            cadence.
          </p>
          <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
            ...
            <TrackLink
              ...
              props={{
                target: "pricing",
                location: "bookkeeping_audit_footer",
              }}
              className="btn-secondary text-sm sm:text-base"
            >
              Compare plans
      ...
      <SeoClusterLinks
        ...
        links={[
          ...
          },
          {
            ...
            description:
              "Build the billing-first software inventory for Xero, QBO, MYOB, practice tools, add-ons, and firm subscriptions.",
          },
          {
            href: "/business-subscription-tracker-small-business",
            title: "Business subscription tracker",
            description:
              "Track renewal dates, owners, payment sources, and action decisions for recurring firm software subscriptions.",
          },
          {
            href: "/saas-spend-audit-tool",
