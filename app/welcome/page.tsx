...
export const metadata: Metadata = buildMetadata({
  title: "Welcome",
  description: "Get started with Distill onboarding and upload your SaaS billing data in minutes.",
  path: "/welcome",
});
    ...
    <main className="min-h-screen bg-dark-950 px-4 py-16 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-6xl space-y-10">
        <div className="rounded-3xl border border-brand-500/20 bg-gradient-to-br from-brand-500/10 via-dark-900 to-dark-950 p-8 sm:p-10">
          <p className="text-xs uppercase tracking-[0.3em] text-brand-400">Welcome to Distill</p>
          ...
          <p className="mt-4 max-w-2xl text-lg text-dark-300">
            Start with your billing data, let Distill analyse spend and overlap, then turn the findings into an executive-ready report.
          </p>
