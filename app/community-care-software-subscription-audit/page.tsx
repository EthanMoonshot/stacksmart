  ...
  return (
    <main className="min-h-screen bg-dark-950 text-white">
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-lg leading-8 text-dark-300">
              Community care, home care, support coordination, and smaller
              care-provider teams often buy software one operational problem at
              a time: rostering, SMS, payroll, onboarding, forms, document
              storage, reporting, telehealth, marketing, and accounting.
              StackSmart gives the owner or operator a clear subscription-spend
              snapshot from billing data only — no participant, patient, or
              clinical records — so they can cut unused seats, duplicate tools,
              and ownerless renewals before the next notice window closes.
            </p>
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <TrackLink
                ...
                props={{
                  target: "demo",
                  location: "community_care_audit_primary",
                }}
              ...
              <TrackLink
                ...
                props={{
                  target: "pricing",
                  location: "community_care_audit_secondary",
                }}
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl border border-brand-400/20 bg-dark-900/80 p-6 sm:p-8">
            ...
            <h2 className="mt-3 text-xl font-semibold text-white sm:text-2xl">
              How should a small community care provider audit software
              subscriptions?
            </h2>
            <p className="mt-4 max-w-3xl text-sm leading-7 text-dark-300">
              Start with billing exports, not sensitive care records. Pull 6 to
              12 months from Xero, MYOB, business cards, direct debits, and
              vendor invoices. Group recurring charges by function, compare seat
              counts against the current roster, identify duplicate tools or
              add-ons, and assign each flagged subscription a keep, cancel,
              downgrade, consolidate, renegotiate, or renewal-owner decision.
              The fastest wins usually come from dormant
              coordinator/admin/support-worker seats, SMS or document packs
              still billing at old usage, and tools purchased for one audit,
              funding, or program change that never got cancelled.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="border-b border-dark-800/80 bg-dark-950 py-14 sm:py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl border border-amber-400/20 bg-dark-900/80 p-6 sm:p-8">
            ...
            <h2 className="mt-3 text-xl font-semibold text-white sm:text-2xl">
              Aged-care and community-care software demand is real — but the
              audit opportunity is the subscription layer
            </h2>
            <p className="mt-4 text-sm leading-7 text-dark-300">
              Today’s DataForSEO AU live check showed community care software at
              30 monthly searches, aged care software at 140 / $19.77 CPC /
              $23.49 high bid, home care software at 110 / $9.10 CPC / $13.23
              high bid, and support coordination software at 140 / $25.25 CPC /
              $33.06 high bid. StackSmart is not trying to replace those
              operating platforms. The buyer-intent wedge is practical:
              owner-led 5-50 staff providers already have care-management,
              rostering, payroll, SMS, forms, document, compliance, accounting,
              and marketing subscriptions, but no mature procurement function to
              keep the stack clean. A billing-export audit turns that messy
              renewal picture into a simple owner/operator keep, cancel,
              downgrade, consolidate, renegotiate, and renewal-owner action
              list.
            </p>
          </div>
        </div>
        ...
        <div className="mx-auto grid max-w-5xl gap-8 px-4 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:px-8">
          <div>
            ...
            <ol className="mt-6 space-y-4">
              {auditSteps.map((step, index) => (
                <li
                  key={step}
                  className="flex gap-4 rounded-xl border border-dark-800 bg-dark-900/70 p-4"
                >
          ...
          <div className="rounded-2xl border border-dark-700 bg-dark-900/80 p-6">
            ...
            <ul className="mt-5 space-y-3 text-sm leading-7 text-dark-300">
              <li>
                • Four inactive support-worker seats still billing in the
                rostering platform.
              </li>
              <li>
                • A duplicate forms tool retained after the care-management
                platform added forms.
              </li>
              <li>
                • SMS and document packs renewing at last year’s program volume.
              </li>
              <li>
                • A compliance/reporting subscription bought for an audit cycle
                with no named renewal owner.
              </li>
              <li>
                • A payroll connector and a separate timesheet app both solving
                the same admin handoff.
              </li>
            </ul>
            <div className="mt-6">
              <TrackLink
                ...
                props={{
                  target: "checklist",
                  location: "community_care_sample_findings",
                }}
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="rounded-2xl border border-emerald-400/20 bg-emerald-500/5 p-6">
              ...
              <ul className="mt-4 space-y-3 text-sm leading-7 text-dark-300">
                <li>
                  • Owner-led community care, home care, support coordination,
                  and smaller care-provider teams.
                </li>
                <li>
                  • Roughly 5–50 staff or contractors with recurring software
                  and add-on subscriptions.
                </li>
                <li>
                  • Low procurement maturity: the owner, operator, practice
                  manager, or admin lead owns the cleanup.
                </li>
              </ul>
            </div>
            <div className="rounded-2xl border border-red-400/20 bg-red-500/5 p-6">
              ...
              <ul className="mt-4 space-y-3 text-sm leading-7 text-dark-300">
                <li>
                  • Enterprise aged-care procurement teams looking for a full
                  vendor-management platform.
                </li>
                <li>
                  • Teams needing clinical/care-record review, care-plan
                  analysis, or compliance advice.
                </li>
                <li>
                  • Providers without billing exports, card statements, or
                  vendor invoices to analyse.
                </li>
              </ul>
            </div>
          </div>
      ...
      <section className="border-b border-dark-800/80 bg-dark-900/30 py-14 sm:py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl border border-brand-400/20 bg-dark-900/80 p-6 sm:p-8">
            ...
            <h2 className="mt-3 text-2xl font-semibold tracking-tight text-white">
              Community-care software audits should start with renewal risk, not
              another platform shortlist
            </h2>
            <p className="mt-4 text-sm leading-7 text-dark-300">
              Live AU demand still shows buyers searching for aged-care software
              (170 monthly searches, CPC about $14.91) and community-care
              software (40 monthly searches). For owner-led providers with 5–50
              staff, the fastest commercial win is usually not replacing the
              care-management system. It is finding the paid layer around it:
              SMS packs, form tools, coordinator seats, payroll connectors,
              onboarding apps, reporting add-ons, document storage, telehealth,
              and renewals nobody owns.
            </p>
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row">
              <TrackLink
                ...
                event="homepage_cta_clicked"
                props={{
                  from: "community_care_2026_06_02",
                  target: "ndis_provider",
                }}
                className="btn-secondary text-sm"
              >
                NDIS provider version
              </TrackLink>
              <TrackLink
      ...
      <section className="border-b border-dark-800/80 bg-dark-950 py-16 sm:py-20">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <p className="text-xs uppercase tracking-[0.18em] text-brand-300">
            2026-06-08 conversion refresh · practical billing-export audit for
            care providers
          </p>
          <h2 className="mt-3 text-2xl font-semibold tracking-tight text-white">
            Run the subscription cleanup from invoices and card statements — no
            participant records needed
          </h2>
          <p className="mt-4 text-sm leading-7 text-dark-300">
            Owner-led community care, home care, and support coordination teams
            carry rostering, care-management add-ons, SMS packs, document
            storage, forms, telehealth, compliance/training tools, payroll
            connectors, and marketing subscriptions — all bought one operational
            problem at a time. The audit starts and finishes with billing data.
            No participant notes, care plans, or clinical files are reviewed.
          </p>
          <div className="mt-8 space-y-4">
            {[
              ...
              <div
                key={item.step}
                className="rounded-xl border border-dark-700 bg-dark-900/70 p-5"
              >
          ...
          <div className="mt-8 rounded-2xl border border-emerald-400/20 bg-emerald-500/5 p-6">
            ...
            <p className="mt-3 text-sm leading-7 text-dark-300">
              StackSmart processes invoices, card statements, accounting
              exports, and vendor receipts. It does not access, request, or
              store participant records, care plans, clinical notes, health
              information, NDIS plan details, or any data covered by privacy
              legislation. The output is a subscription-level action list for
              the provider owner or operations lead — not clinical advice,
              compliance evidence, or care-management reporting.
            </p>
          </div>
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <TrackLink
              href="/demo"
              event="homepage_cta_clicked"
              props={{ from: "community_care_2026_06_08", target: "demo" }}
              className="btn-primary text-sm"
            >
              See sample care-provider report
            </TrackLink>
            <TrackLink
              href="/software-subscription-audit-checklist"
              event="homepage_cta_clicked"
              props={{ from: "community_care_2026_06_08", target: "checklist" }}
              className="btn-secondary text-sm"
            >
              Use the audit checklist
            </TrackLink>
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
            <div>
              ...
              <p className="mt-4 text-sm leading-7 text-dark-300">
                A community-care provider does not need an enterprise
                procurement suite to find waste. Most owner-led teams need a
                practical billing pass across rostering, care-management,
                plan-management, payroll, SMS, document-signing, compliance,
                telehealth, HR, marketing, and accounting subscriptions.
                StackSmart starts with invoices, card statements, accounting
                exports, direct debits, and vendor receipts — not participant
                records or care notes — then turns the list into owner/operator
                decisions before the next renewal window.
              </p>
              <div className="mt-6 flex flex-wrap gap-3 text-sm">
                <TrackLink
                  ...
                  event="homepage_cta_clicked"
                  props={{
                    from: "community_care_2026_07_09",
                    to: "ndis_provider_audit",
                  }}
                ...
                <TrackLink
                  href="/demo"
                  event="homepage_cta_clicked"
                  props={{ from: "community_care_2026_07_09", to: "demo" }}
                  className="rounded-full border border-dark-700 px-4 py-2 text-brand-200 hover:border-brand-400/60"
                >
                  Sample report
                </TrackLink>
            ...
            <div className="rounded-2xl border border-dark-700 bg-dark-900/70 p-6">
              ...
              <ul className="mt-4 space-y-3 text-sm leading-7 text-dark-300">
                <li>
                  ...
                  support-worker, coordinator, and admin seats still licensed
                ...
                <li>
                  ...
                  SMS, forms, signatures, compliance, document storage, and
                  reporting packs no one has re-priced.
                </li>
                <li>
                  <span className="font-semibold text-white">
                    Ownerless renewals:
                  </span>{" "}
                  tools bought for one program, funding change, audit prep, or
                  trial that now renew from an old card.
                </li>
                <li>
                  <span className="font-semibold text-white">
                    Action output:
                  </span>{" "}
                  keep, cancel, downgrade, consolidate, renegotiate, or assign a
                  renewal owner — without touching participant data.
                </li>
              </ul>
            </div>
          </div>
        ...
        links={[
          {
            ...
            description:
              "Clean up rostering, plan-management, SMS, compliance, and support-worker seat costs.",
          },
          {
            href: "/allied-health-software-subscription-audit",
            title: "Allied health software audit",
            description:
              "Audit PMS add-ons, telehealth, reminders, forms, AI scribes, and contractor clinician seats.",
          },
          {
            href: "/childcare-software-subscription-audit",
            title: "Childcare software audit",
            description:
              "Find enrolment, parent-comms, CCS billing, rostering, and compliance subscription waste.",
          },
          {
            href: "/software-subscription-audit-checklist",
            title: "Software subscription audit checklist",
            description:
              "Use the owner/operator checklist before the next renewal window closes.",
          },
          {
            href: "/saas-spend-audit-tool",
            title: "SaaS spend audit tool",
            description:
              "Turn billing exports and statements into a practical software-spend action list.",
          },
          {
            href: "/small-business-software-audit",
            title: "Small business software audit",
            description:
              "See the broader StackSmart audit workflow for owner-led SMBs.",
          },
        ]}
      />
