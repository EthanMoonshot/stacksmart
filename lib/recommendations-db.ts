...
const tools: ToolInfo[] = [
  ...
  },
  {
    ...
    typicalMonthlyCost: 8,
    overlapsWith: ["Confluence", "Coda", "Google Docs", "GitBook"],
    alternatives: [
  ...
  },
  {
    ...
    alternatives: [
      createAlternative(5.75, "Notion", 8, "Combines docs, lightweight projects, and internal wiki workflows in one simpler workspace.", "Best if your team wants one flexible workspace rather than Atlassian-style admin."),
      createAlternative(5.75, "Coda", 10, "Stronger doc-database hybrid for SMBs that run workflows directly from docs.", "Worth it when docs also need to behave like lightweight apps."),
      createAlternative(5.75, "GitBook", 6.7, "Cleaner publishing and knowledge-base UX for teams focused on structured documentation.", "Strong option for product docs and help centres with less process baggage."),
    ],
  },
  {
    name: "Coda",
  ...
  },
  {
    ...
    overlapsWith: ["Sketch", "Adobe XD", "Adobe Creative Cloud", "Canva Pro"],
  },
  {
    name: "Sketch",
    category: "Design",
  ...
  { name: "ActiveCampaign", category: "Marketing", typicalMonthlyCost: 29, overlapsWith: ["HubSpot", "Mailchimp"] },
  {
    name: "Pipedrive",
    category: "Sales",
  ...
  { name: "AWS", category: "Cloud Infrastructure", typicalMonthlyCost: 0, overlapsWith: ["Google Cloud", "Azure"] },
  { name: "Google Cloud", category: "Cloud Infrastructure", typicalMonthlyCost: 0, overlapsWith: ["AWS", "Azure"] },
